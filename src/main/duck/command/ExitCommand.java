...
/**
 * This is a <code>Command</code> to indicate a termination of user input.
 * This changes the status of <code>isExit</code> status to be <code>true</code>, while for all other commands, the
 * status is set to be <code>false</code>.
 */
