...
public class Storage {
    ...
    /**
     * Loads tasks from the <code>file</code>.
     * A new <code>Task</code> object is created from each line in the file and added to the task list.
     *
     * @return                          a <code>TaskList</code> object containing all tasks loaded from the
     *                                  hard disk storage
    ...
    /**
     * Writes every tasks in the current task list to the hard disk in the form of strings.
     * Specific tasks, <code>Todo</code>, <code>Deadline</code>, or <code>Event</code> will be distinguished by a
     * starting letter: T, D, or E, in order to load the same-type task back from storage.
     *
     * @param taskList       a <code>TaskList</code> object of which the information about tasks will be recorded to
     *                       the <code>file</code>
