public class DeleteCommand extends Command {
    ...
    /**
     * Represents the command of deleting a task from tasklist.
     * @param instruction refers to the task number which needs to be deleted
     */
    ...
    public String execute(TaskList tasks, UI ui, Storage storage) {
        try {
            if (instruction.equals("")) {
                ...
                Task tsk = tasks.removeFromList(Integer.parseInt(instruction) - 1);
                try {
