...
public class Duke extends Application {
    ...
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/DaMith.png"));

    public Duke() {
        this("./data/duketasks.txt");
    }
    ...
    public void start(Stage stage) {
        ...
        //Welcome text
        Label dukeWelcomeText = new Label("Hello! I'm Duke\nWhat can I do for you?");
        dialogContainer.getChildren().addAll(DialogBox.getDukeDialog(dukeWelcomeText, new ImageView(duke)));
    }
