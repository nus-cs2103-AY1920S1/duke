...
public class Duke extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/TestSubject.jpg"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/GLaDOS.png"));
