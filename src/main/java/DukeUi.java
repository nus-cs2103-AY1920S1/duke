public class DukeUi {
    //Greeting Messages
    public final static String GREET_HELLO
    ...
    public final static String FEEDBACK_TASK_ADDED
        = "Gotcha! I've added a new task:\n  %s\nYou've got %d tasks in your list.";

    public final static String FEEDBACK_TASK_DONE
        = "Good job! I've marked this task as done:\n  %s";

    public final static String FEEDBACK_TASK_DELETE
