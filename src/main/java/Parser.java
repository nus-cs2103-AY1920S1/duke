    ...
    */
    public static String handleCommand(String input) throws DukeException {
        ...
        switch (in) {
            ...
            case "delete":
                if (others.equals("done")) {
                    TaskList.removeDone();
                } else if (others.equals("all")) {
                    TaskList.removeAll();
                } else {
            ...
            case "deadline":
                {
                    ...
                    try {
                        ...
                        throw new DukeException(
                            "Wrong format for deadline! Format: <name> /by dd/mm/yyyy hhmm"
                        );
                    }
                }
            case "event":
                {
                    ...
                    try {
                        ...
                        throw new DukeException(
                            "Wrong format for event! Format: <name> /at dd/mm/yyyy hhmm"
                        );
                    }
                }
            case "find":
