package SerSlacksalot.taskList;
...
public class TaskList {
    ...
    public String markAsDone(String command) throws DukeException{
        ...
        if (completedTaskNumber > tasks.size()){
            throw new DukeException("taskList.TaskList Exception: Index of task not found");
        }
    ...
    public String deleteTask(String command) throws DukeException{
        ...
        if (index <= tasks.size() && index > 0) {
            ...
            throw new DukeException("taskList.TaskList Exception: Index of task to be deleted not found.");
        }
        return output;
    }
