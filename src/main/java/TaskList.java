...
/**
 * Encapsulates the TaskList object that is responsible of maintaining a temporary list of existing task.
 * The list of task can be subjected to edits.
 */
public class TaskList {
    ArrayList<Task> taskStorage;

    /**
     * Constructs the TaskList object. A list of task can be fed to this constructor
     * to build a list of existing tasks.
