...
public class DoneCommand extends Command {
     ...
     * @throws DudeException If command has invalid format: not "done" followed by a single integer.
     */
    @Override
    public void execute(TaskList tasks, Ui ui, Storage storage) throws DudeException {
        try {
            if (inputSplit.length != 2) {
                ...
                throw new DudeException(":( OOPS!!! Please specify number of a single task to mark as done.\n");
            }
