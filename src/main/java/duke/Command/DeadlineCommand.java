...
public class DeadlineCommand {
    ...
    public String Deadline(TaskList tasks, Ui ui, Storage store, String msg) throws IOException {
        ...
        String output = ui.print_deadline(sub, new_timeFrame, tasks.get_NoOfTasks());
        return output;
    }
}
