...
/**
 * DateTimeHelper class formats numerical dates and 24-hour time into readable dates and 12-hour time.
 *
 * @author scwaterbear
 */
class DateTimeHelper {

    /** Days of a month ordinals */
    ...
    /**
     * Returns a readable date and 12-hour time.
     *
     * @param dateAndTime numerical date and 24-hour time.
     * @return String readable date and 12-hour time.
     * @throws DukeException If invalid date time format.
     */
    static String convertDateToString(String dateAndTime) throws DukeException {
