...
public class Deadline extends Task implements Serializable {
     ...
     * @param description indicates what the task is about and when the deadline is
     * @throws DukeException when input does not meet required format or '/by' is not specified.
     */
