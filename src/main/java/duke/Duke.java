...
public class Duke extends Application {
    ...
    public Duke() {
        ...
        try {
            ...
            handleError("No saved tasks were found!");
...
//    }
     ...
     */
    private String getResponse(String input) throws DukeException, NoSuchElementException{
     ...
     * @param s An error message that Duke prints to the GUI for the user.
     */
    private void handleError(String s) {
        Label dukeText = new Label(s);
        this.dialogContainer.getChildren().addAll(
                DialogBox.getDukeDialog(dukeText, new ImageView(this.duke)));
        this.userInput.clear();
    }
