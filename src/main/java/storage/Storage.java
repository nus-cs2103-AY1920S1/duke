...
public class Storage {
    ...
    public String saveTaskList(ArrayList<Task> tasks) throws Exception{
        ...
        try {
            ...
            if (isArchive) {
                ...
                output += "task.Task list has been saved!";
            }
        } catch (IOException ioe) {
            System.err.println("IOException: " + ioe.getMessage());
            throw new DukeException("storage.Storage Exception: Error when writing to file.");
        }
        return output;
    }
    ...
    public TaskList displayTaskList() throws DukeException {
        ...
        try {
            ...
            System.err.println("IOException: " + ioe.getMessage());
            throw new DukeException("storage.Storage Exception: Error when reading " + fileToOpen);
        }
