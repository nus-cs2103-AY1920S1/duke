...
public class Parser {
    ...
    public static Command parse(String fullCommand) throws DukeException {
        ...
        try {
            ...
            throw new DukeException("Please enter the date in the format dd-MMM-yyyy HH:mm");
        } catch (ArrayIndexOutOfBoundsException e) {
            throw new DukeException("Please check the format of your input!");
        }
        counter++;
        return c;
    ...
    /* Parser class stuff */
    private static void checkCommand(String[] commandArr, String keyword) throws DukeException {
