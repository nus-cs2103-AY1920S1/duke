...
import weomucat.doko.ui.gui.message.MessageBox;
import weomucat.doko.ui.gui.message.UserMessage;
import weomucat.doko.ui.listener.UserInputListener;

/**
 * Represents the root controller of Doko's {@link GraphicalUi}.
 */
public class Root extends VBox {
  ...
  /**
   * Creates a root controller of Doko's {@link GraphicalUi}.
   */
  public Root() {
  ...
  @FXML
  private void userInputOnAction() throws DokoException {
