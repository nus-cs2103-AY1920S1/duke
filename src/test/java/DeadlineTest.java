...
public class DeadlineTest {
    ...
    public void dateToStringConversion_validDates_success() throws Exception {
        assertEquals("1st of January 2019, 06:00PM", (new Deadline("test event 1","1/1/2019 1800")).dateToString());
        assertEquals("13th of February 2019, 09:00AM", (new Deadline("test event 2","13/2/2019 0900")).dateToString());
        assertEquals("3rd of August 2019, 05:30PM", (new Deadline("test event 3","3/8/2019 1730")).dateToString());
    }
