...
public class AddCommandTest {
    ...
    // Test to-do Formats
    @Test
    public void testingToDoCorrectParseDescription() {
        try {
    ...
    @Test
    public void testingToDoWrongParseDescription() {
        try {
    ...
    @Test
    public void testingWrongDeadlineParseDescription() {
        try {
    ...
    // Test Event Formats
    @Test
    public void testingCorrectEventParseDescription() {
        try {
            assertEquals("Make the bed ",
    ...
    @Test
    public void testingWrongEventParseDescription() {
        try {
    ...
    @Test
    public void testingWrongEventParseDescription2() {
        try {
    ...
    @Test
    public void testingWrongEventParseDescription3() {
        try {
