...
* **task** are reusable blocks of logic.  For example, the task `clean` simply deletes the project build directory. task can be composed of other tasks or be dependent on another task. 
