...
Next, we create another Java class, `seedu.duke.Launcher`, as an entry point to our application.
The `seedu.duke.Launcher` class is reproduced below in its entirety.
 ...
 */
public class seedu.duke.Launcher {
...
Run `seedu.duke.Launcher` and you should see something like this:
