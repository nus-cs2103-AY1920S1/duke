...
Next, we create another Java class, `seedu.duke.core.Launcher`, as an entry point to our application.
The `seedu.duke.core.Launcher` class is reproduced below in its entirety.
 ...
 */
public class seedu.duke.core.Launcher {
...
Run `seedu.duke.core.Launcher` and you should see something like this:
