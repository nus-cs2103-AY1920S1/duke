...
Next, we create another Java class, `duke.ui.Launcher`, as an entry point to our application.
The `duke.ui.Launcher` class is reproduced below in its entirety.
...
Run `duke.ui.Launcher` and you should see something like this:
