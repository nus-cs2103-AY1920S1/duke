# JavaFX Tutorial Part 2 - Creating a GUI for IceBear

In this tutorial, we will be creating a GUI for IceBear from scratch based on the following mockup.

![Mockup for IceBear](assets/DukeMockup.png)
...
![IceBear's layout](assets/DukeSceneGraph.png) 
...
![IceBear's raw layout](assets/RawLayout.png)
...
![IceBear's Final layout](assets/FinalLayout.png)
