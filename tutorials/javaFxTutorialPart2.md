# JavaFX Tutorial Part 2 - Creating a GUI for duke.util.Duke

In this tutorial, we will be creating a GUI for duke.util.Duke from scratch based on the following mockup.

![Mockup for duke.util.Duke](assets/DukeMockup.png)
...
![duke.util.Duke's layout](assets/DukeSceneGraph.png) 
...
![duke.util.Duke's raw layout](assets/RawLayout.png)
...
![duke.util.Duke's Final layout](assets/FinalLayout.png)
