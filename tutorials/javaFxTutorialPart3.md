...
We use the code in our duke.ui class just like any other control. Here are the steps to update the code to use the custom control in `duke.ui.Main.java`.
...
Next, add two images to the `duke.ui/resources/images` folder.
